    ...
    if($_REQUEST['funcao'] == 'lista_produtos'){
     ...
     echo "<p/><!--<center>"
       ...
       echo "<p/><center>"
        ...
        echo " <center><p><div style='width:90%;text-align:right'><input onclick='javascript:document.getElementById(\"ffffff\").style.display = \"block\"' type='button' value='Pesquisar'></div></p>
            

    <div id='ffffff' style='display:none'><table width='90%' border='1'>
