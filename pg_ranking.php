<h4><a href="template.php">Praça Eletrônica de Negócios</a> >> <a href='template.php?conteudo=pg_inicial4'>Quero Crédito</a> >> Consulte Ranking das Linhas de Crédito </h4>
...
<div style="width: 97%;
	...
	<div style='display: inline-block;'>Escolha a região:</div> <div>
					 <?php
				...
				<div id='div_muni<?php echo $numero_componente; ?>' style='display:none'></div>
	...
	<div id='a1' style='display:none;' >
		<center>
			<img src='images/ranking.jpg' style='width:90%;height:90%'>
		</center>
	</div>
