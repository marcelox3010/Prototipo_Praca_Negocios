	...
	<div style="display: table-row; " >
		...
		<div style="display: table-cell;-align:right;"><b>N° do Edital/Ano</b> </div>
			<div style="display: table-cell;"> 
						...
						<input type='text' size='4' value='2014' maxlength='4'/> / <select style='width:100px;padding:0px;margin:0px;'>
							  <option value="volvo">Todos</option>
							  <option value="volvo" selected>2014</option>
		...
		<div style="display: table-row; ">
			...
			<div style="display: table-cell;"> 
						 <select style='width:100px;padding:0px;margin:0px;'>
							  ...
							  <option value="saab" selected>Estadual</option>															  
		...
		<div style="display: table-cell;-align:right;"><b>Órgão Comprador:</b></div>
			<div style="display: table-cell;"> 
						...
						<select style='width:500px;padding:0px;margin:0px;'>
							  ...
							  <option value="saab" selected>Ministério do Desenvolvimento Social</option>															  
				...
				<div style='float:left;'>
					<div>
						...
						>
							  ...
							  <option value="CO" selected>Centro-Oeste</option>															  
		...
		<div style="display: table-row; ">
			...
			<div style="display: table-cell; "> 
						 ...
						 <select style='width:200px;padding:0px;margin:0px;'>
							  ...
							  <option value="saab" selected>Melhor Técnica</option>															  
			...
			<div style="display: table-cell;   "> 
						...
						<div id='s2'  >
							<select style='margin:0px'>
								...
								<option selected>Sapato 3</option>
		...
		<div style="display: table-row; ">
			...
			<div style="display: table-cell;text-align:right;"> 
						...
						<input type='button' value='Salvar Abrangência' onclick='javascript:  document.location = "template.php?conteudo=pg_abrangencia_salvas"'>
