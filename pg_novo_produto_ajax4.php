 ...
 */
    ...
    if($_REQUEST['funcao'] == 'lista_produtos'){
     ...
     echo "<p/><center>"
       ...
       echo "<p/><center>"
                . "<table border='1' width='90%'>"
                . "<caption><h4>Outras Informações</h4></caption>"                
                . "<tr>"
                . "<td>Quantidade:</td> "
                . "<td>"
                . "<input type='text'>"
             ...
             . "<tr>"
                . "<td>Valor Unitário Estimado:</td> "
                . "<td><input type='text'></td>"
                . "</tr>"
               . "<tr>"
                . "<td>Estado:</td> "
                . "<td><select style='padding:0px;margin:0px'><option>Acre</option><option>Minas Gerais</option><option>Rio de Janeiro</option><option>Distrito Federal</option> </select></td>"
                . "</tr>"
            . "<tr>"
                . "<td>Observações para Compra:</td> "
        ...
        echo "<p/><center><input onclick='javascript: alert(\"Protocolo: XXXXXX.\"); document.location=\"template.php\"' type='button' value='Salvar Registro de Intenção de Compra'></center>";
