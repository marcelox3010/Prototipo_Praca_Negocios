...
<div style="width: 98%;
	...
	<div style="width: 100%; display: table;border-spacing: 0 13px;">	
		...
		<div style="display: table-row; background-color:#eeeeee;">
			<div style="display: table-cell;width:300px ">
				<b>
					Dados da Micro e Pequena Empresa
				</b>			
			</div>
	...
	<div align='center'>
		...
		<div align='right'>
			...
			<input type='button' value='Prosseguir' onclick='
			
				document.location = "template.php?conteudo=pg_simples_internacional2"
