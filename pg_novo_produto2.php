<script>
    ...
    function showResult(str) {
        ...
        xmlhttp.open("GET", "pg_novo_produto_ajax4.php?funcao=lista_produtos&q="+str, true);
        xmlhttp.send();
    ...
    function detalha_produto(str) {
        ...
        xmlhttp.open("GET", "pg_novo_produto_ajax4.php?funcao=detalha_produto&q="+str, true);
        xmlhttp.send();
...
<h4><a href="template.php">Praça Eletrônica de Negócios</a> >> <a href='template.php?conteudo=pg_inicial3'>Quero Comprar</a> >> Registre uma Intenção de Compra </h4>
