<script>
    ...
    function detalha_produto(str) {
        ...
        xmlhttp.open("GET", "pg_novo_produto_ajax3.php?funcao=detalha_produto&q="+str, true);
        xmlhttp.send();
...
<div style="width: 97%;
    ...
    <h4>
        <?php if($_REQUEST['comprar'] == '' ){ ?>
        
            <a href="template.php">Praça Eletrônica de Negócios</a> >> <a href='template.php?conteudo=pg_inicial2'>Quero Vender</a> >>   <a href='template.php?conteudo=pg_inicial2'>Encontre Clientes</a> >> Encontre Possível Comprador</h4>
        
        <?php } else {?>
            
            <a href="template.php">Praça Eletrônica de Negócios</a> >> <a href='template.php?conteudo=pg_inicial3'>Quero Comprar</a> >> Encontre Empresas Fornecedoras</h4>
