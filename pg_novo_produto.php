<script>
    ...
    function showResult(str) {
        ...
        xmlhttp.open("GET", "pg_novo_produto_cpm_ajax.php?funcao=lista_produtos&q="+str, true);
        xmlhttp.send();
    ...
    function detalha_produto(str) {
        ...
        xmlhttp.open("GET", "pg_novo_produto_cpm_ajax.php?funcao=detalha_produto&q="+str, true);
        xmlhttp.send();
