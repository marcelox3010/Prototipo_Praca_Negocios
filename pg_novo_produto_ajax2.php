    ...
    if($_REQUEST['funcao'] == 'lista_produtos'){
     ...
     echo "<p/><!--<center>"
       ...
       echo "<p/><center>"
        ...
        echo "<p/><center><input onclick='javascript:document.getElementById(\"tb_biquini\").style.display = \"block\"' type='button' value='Pesquisar'></center>"
       . ""
                . "<p>&nbsp;</p><div style='display:none;' id='tb_biquini'><center>"
                . "<table border='1' width='90%'>"
                . "<tr>"
                . "<th>Empresa</th>"
                . "<th>Produto</th>"
                ...
                . "</tr>"
                . "<tr>"
                . "<td>Biquinis e CIA</td>"
                . "<td>Biquini</td>"
                . "<td align=right>10</td>"
                . "<td align=center>DF</td>"
                . "<td align=center><a href='template.php?conteudo=pg_prod'>Detalhar</a></td>"                
                . "</tr>"
                . "<tr>"
                . "<td>Chez Biquinis</td>"
                . "<td>Biquini Franceses</td>"
