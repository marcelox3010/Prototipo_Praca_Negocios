...
<div style="width: 98%;
	...
	<div style="width: 100%; display: table;border-spacing: 0 13px;">
		...
		<div style="display: table-row">
			...
			<div style=" display: table-cell; ">Modo de Apresentação:</div>
			<div style=" display: table-cell; ">
				
				<input type='radio' name='i1' <?php echo $c1; ?>  onclick='
				
					document.getElementById("f1").style.display = "block";
					document.getElementById("f2").style.display = "none";
				
				'/> Por necessidade para minha empresa<br/>
				<input type='radio' name='i1'  <?php echo $c2; ?> onclick='
				
					document.getElementById("f1").style.display = "none";
					document.getElementById("f2").style.display = "block";
				
				'/> Por tipo/linha de crédito<br/>
		...
		<div style="display: table-row">
			...
			<div style=" display: table-cell; ">Necessidade:</div>
			<div style="display: table-cell; ">				
				
				<div id='f1' style='<?php echo $s1; ?>'>
					<input type='checkbox' name='xy1' name='xy1'  onclick='
                                            
                                                        
                                                        if(!document.getElementById("xy8").checked){
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        />  Desejo crédito para comprar máquinas<br/>
					<input type='checkbox' name='xy2' id='xy2' onclick='
                                                        if(!document.getElementById("xy8").checked){
                                                        document.getElementById("a1").style.display = "block";
                                                        document.getElementById("a2").style.display = "block";
							document.getElementById("a3").style.display = "none";
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        }'/> Desejo crédito para comprar equipamentos<br/>
					<input type='checkbox' name='xy3' id='xy3' onclick='
                                                        if(!document.getElementById("xy8").checked){
                                                        document.getElementById("a1").style.display = "block";
                                                        document.getElementById("a2").style.display = "block";
							document.getElementById("a3").style.display = "none";
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        }'/> Desejo crédito para construir ou reformar<br/>
					<input type='checkbox' name='xy4' id='xy4' onclick='
                                                        if(!document.getElementById("xy8").checked){
                                                        document.getElementById("a1").style.display = "block";
                                                        document.getElementById("a2").style.display = "block";
							document.getElementById("a3").style.display = "none";
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        }'/> Desejo crédito para implantar fábrica<br/>
					<input type='checkbox' name='xy5' id='xy5' onclick='
                                                        if(!document.getElementById("xy8").checked){
                                                        document.getElementById("a1").style.display = "block";
                                                        document.getElementById("a2").style.display = "block";
							document.getElementById("a3").style.display = "none";
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        }'/>Desejo crédito para compra de matéria prima<br/>
					<input type='checkbox' name='xy6' id='xy6' onclick='
                                                        if(!document.getElementById("xy8").checked){
                                                        document.getElementById("a1").style.display = "block";
                                                        document.getElementById("a2").style.display = "block";
							document.getElementById("a3").style.display = "none";
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        }'/> Desejo crédito para desconto de recebíveis (duplicatas) ou cheques pré datados<br/>
					<input type='checkbox' name='xy7' id='xy7' onclick='
                                                        if(!document.getElementById("xy8").checked){
                                                        document.getElementById("a1").style.display = "block";
                                                        document.getElementById("a2").style.display = "block";
							document.getElementById("a3").style.display = "none";
							...
							document.getElementById("a6").style.display = "block";
                                                        ...
                                                        }'/> Desejo crédito para adiantamento de vendas com cartão de crédito<br/>
				
					<input type='checkbox' name='xy8' id='xy8' onclick='
						...
						'/> Desejo crédito para pagar funcionários, impostos e tributos.</br>				
				</div>
				
				<div id='f2' style='<?php echo $s2; ?>'>
					<!--onchange="
					...
					-->
                                        ...
                                        <input type='checkbox' id='ff1' value="1" onclick='
							...
							document.getElementById("a6").style.display = "block";
                                               ...
                                               '> Capital de Giro</option>
						
                                       <input type='checkbox' id='ff2' value="2" onclick='
							...
							document.getElementById("a6").style.display = "block";
                                       ...
                                       <input type='checkbox' id='ff3' value="3" onclick='
